...
//	       결과행 하나 가져오기.
	         ...
	         e.printStackTrace();
	         System.out.println("checkPostNumber() 실행 중 에러");
	      } finally {
	         try {
	            DBConnection.close(con, pstm, rs);
	         } catch (SQLException e) {
	            e.printStackTrace();
	            System.out.println("checkPostNumber() 닫는 도중 에러");
	         }
	      }
	      return check;
	   }
...
//	       결과행 하나 가져오기.
	         ...
	         e.printStackTrace();
	         System.out.println("checkMemberNumber() 실행 중 에러");
	      } finally {
	         try {
	            DBConnection.close(con, pstm, rs);
	         } catch (SQLException e) {
	            e.printStackTrace();
	            System.out.println("checkMemberNumber() 닫는 도중 에러");
	         }
	      }
	      return check;
	   }
